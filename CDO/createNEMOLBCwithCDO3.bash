...
INPUT_DATASET=$2
INPUT_DATASET_SSH=$3
OUTPUT_DATASET=${OUTPATH}/NEATL36_east2_CDO_GLO_${DATEYMD}_${METHOD}.nc
...
if ! [ -f "${TARGET_HGRID_PATH}" ];
	echo "${TARGET_HGRID_PATH} not found"
	exit 1
fi

if ! [ -f "${TARGET_VGRID_PATH}" ];
	echo "${TARGET_VGRID_PATH} not found"
	exit 2
fi
