...
OUTPUT_DATASET="test_out_cons3.nc"
TEMPORARY_FILE="tmp.nc"
TEMPORARY_FILE2="tmp2.nc"
TEMPORARY_FILE3="tmp3.nc"
BOX="13,14,54,55.6"
...
cdo -aexpr,"uo=(-1)*uo*gcost-vo*gsint;vo=uo*gsint-vo*gcost" ${TEMPORARY_FILE} ${TEMPORARY_FILE2}
mv ${TEMPORARY_FILE2} ${TEMPORARY_FILE}
